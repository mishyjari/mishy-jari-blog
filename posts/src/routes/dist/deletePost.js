...
router["delete"]('/api/posts/:id', common_1.currentUser, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var post, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                ;
                return [4 /*yield*/, post_1.Post.deleteOne(post)];
            case 2:
                _a.sent();
                res.status(204).send({});
                return [3 /*break*/, 4];
            case 3:
                err_1 = _a.sent();
                console.log('Error in delete post route handler', err_1);
                res.status(500).send({});
                return [3 /*break*/, 4];
